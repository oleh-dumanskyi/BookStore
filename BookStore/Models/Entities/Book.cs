...
public class Book
{
    ...
    [Required] [Display(Name = "Автор")] public string Author { get; set; }

    [Required] [Display(Name = "Язык")] public string Language { get; set; }

    [Required]
    [Display(Name = "Страницы")]
    public int Pages { get; set; }

    [Required] [Display(Name = "Жанр")] public string Genre { get; set; }
